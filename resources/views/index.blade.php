    ...
    <section class="food_section layout_padding">
        <div class="container">
            ...
            <ul class="filters_menu">
                ...
                <li data-filter=".bread">Bánh mỳ</li>
                <li data-filter=".fruit">Trái cây</li>
                <li data-filter=".snack">Đồ ăn nhanh</li>
                <li data-filter=".drink">Thức uống</li>
            </ul>

            <div class="filters-content">
                <div class="row grid">
                    @foreach($products as $product)
                        <div class="col-sm-6 col-lg-4 all {{$product->Category()->first()->slug}}">
                            <div class="box">
                                <div>
                                    <div class="img-box">
                ...
                <div class="owl-carousel client_owl-carousel">
                    <div class="item">
                        <div class="box">
                            <div class="detail-box">
                                <p>
                                    Web làm rất chất lượng,tuyệt vời,không có gì để chê
                                </p>
                                <h6>
                                    Moana Michell
                                </h6>
